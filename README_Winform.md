...
​![](docs/images/winform/获取Cookie-1.png)​

2.点击页面右上角的"..."，然后点击复制链接

​![](docs/images/winform/获取Cookie-2.png)​

3.将复制后的链接通过任意方式(QQ/微信等等等)发到电脑上然后复制粘贴到软件中，然后点击"获取并填写Cookie"按钮即可

​![](docs/images/winform/获取Cookie-3.png)​

4.如果链接正确Cookie就会获取成功，右下角会弹出获取成功的提示并自动跳转到绑定图书馆的界面

​![](docs/images/winform/获取Cookie-4.png)​
...
​![](docs/images/winform/绑定图书馆-1.png)​

2.选择需要绑定的场馆(只能选择一个)

​![](docs/images/winform/绑定图书馆-2.png)​

3.选择完后点击确定即可完成绑定，右侧会显示绑定的场馆的信息

​![](docs/images/winform/绑定图书馆-3.png)​
...
​![](docs/images/winform/占座-1.png)​

2.打开占座的操作开关，如实时数据正常显示则表示已经开始占座了

​![](docs/images/winform/占座-2.png)​
...
更新日志请参见[项目页面](https://latiao.vip/%E9%A1%B9%E7%9B%AE%E5%8F%91%E5%B8%83/14.html)
