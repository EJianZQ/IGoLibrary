...
3. 弹窗第一步会显示授权二维码。使用已经在微信绑定好"我去图书馆"学校等信息的**微信**扫描该二维码，完成“我去图书馆”授权并复制授权链接
4. 点击 `下一步`，弹窗会显示手机提交二维码和访问地址
5. 用微信扫描手机提交二维码，打开手机提交页
6. 在手机提交页点击 `点击粘贴链接`。如果微信浏览器限制读取剪贴板，就手动粘贴授权链接
7. 点击 `发送到电脑`。提交成功后，电脑端会自动获取 Cookie，刷新授权状态和场馆配置，并关闭临时快传服务
