...
internal static class DefaultTraceIntProtocolTemplates
{
    internal const string LegacyGetCookieUrlTemplate = "http://wechat.v2.traceint.com/index.php/urlNew/auth.html?r=https%3A%2F%2Fweb.traceint.com%2Fweb%2Findex.html&code=ReplaceMeByCode&state=1";

    public static TraceIntProtocolTemplates Instance { get; } = new()
    {
        ...
        QueryLibraryRuleTemplate = """{"operationName":"libRule","query":"query libRule($libId: Int!) {\n userAuth {\n reserve {\n libRule(libId: $libId) {\n advance_booking\n lib_seat_ttl\n lib_hold_ttl\n lib_renew_time\n hold_reason\n close_start_date\n close_end_date\n open_time\n open_time_str\n close_time\n close_time_str\n lib_validate_time\n }\n }\n }\n}","variables":{"libId":ReplaceMe}}""",
        QueryReservationInfoTemplate = """{"operationName":"index","query":"query index($pos: String!, $param: [hash]) {\n userAuth {\n oftenseat {\n list {\n id\n info\n lib_id\n seat_key\n status\n }\n }\n message {\n new(from: \"system\") {\n has\n from_user\n title\n num\n }\n indexMsg {\n message_id\n title\n content\n isread\n isused\n from_user\n create_time\n }\n }\n reserve {\n reserve {\n token\n status\n user_id\n user_nick\n sch_name\n lib_id\n lib_name\n lib_floor\n seat_key\n seat_name\n date\n exp_date\n exp_date_str\n validate_date\n hold_date\n diff\n diff_str\n mark_source\n isRecordUser\n isChooseSeat\n isRecord\n mistakeNum\n openTime\n threshold\n daynum\n mistakeNum\n closeTime\n timerange\n forbidQrValid\n renewTimeNext\n forbidRenewTime\n forbidWechatCancle\n }\n getSToken\n }\n currentUser {\n user_id\n user_nick\n user_mobile\n user_sex\n user_sch_id\n user_sch\n user_last_login\n user_avatar(size: MIDDLE)\n user_adate\n user_student_no\n user_student_name\n area_name\n user_deny {\n deny_deadline\n }\n sch {\n sch_id\n sch_name\n activityUrl\n isShowCommon\n isBusy\n }\n }\n }\n ad(pos: $pos, param: $param) {\n name\n pic\n url\n }\n}","variables":{"pos":"App-\u9996\u9875"}}""",
        ReserveSeatTemplate = """{"operationName":"reserueSeat","query":"mutation reserueSeat($libId: Int!, $seatKey: String!, $captchaCode: String, $captcha: String!) {\n userAuth {\n reserve {\n reserueSeat(\n libId: $libId\n seatKey: $seatKey\n captchaCode: $captchaCode\n captcha: $captcha\n )\n }\n }\n}","variables":{"seatKey":"ReplaceMeBySeatKey","libId":ReplaceMeByLibID,"captchaCode":"","captcha":""}}""",
        CancelReservationTemplate = """{"operationName":"reserveCancle","query":"mutation reserveCancle($sToken: String!) {\n userAuth {\n reserve {\n reserveCancle(sToken: $sToken) {\n timerange\n img\n hours\n mins\n per\n }\n }\n }\n}","variables":{"sToken":"ReplaceMe"}}""",
        TomorrowReservationWarmUpTemplate = """{"operationName":"libLayout","query":"query libLayout($libId: Int!) {\n userAuth {\n prereserve {\n libLayout(libId: $libId) {\n seats_booking\n seats_total\n seats_used\n }\n }\n }\n}","variables":{"libId":ReplaceMeByLibID}}""",
        TomorrowReservationSaveTemplate = """{"operationName":"save","query":"mutation save($key: String!, $libid: Int!, $captchaCode: String, $captcha: String) {\n userAuth {\n prereserve {\n save(key: $key, libId: $libid, captcha: $captcha, captchaCode: $captchaCode)\n }\n }\n}","variables":{"key":"ReplaceMeBySeatKey","libid":ReplaceMeByLibID,"captchaCode":"","captcha":""}}""",
        TomorrowReservationInfoTemplate = """{"operationName":"prereserve","query":"query prereserve {\n userAuth {\n prereserve {\n prereserve {\n day\n lib_id\n seat_key\n seat_name\n is_used\n }\n }\n }\n}","variables":{}}"""
    };
}
