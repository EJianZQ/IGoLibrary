...
public sealed class ArchitectureClosureTests
{
    ...
    public void ExtractedPageViewModels_DoNotReferenceMainWindowWorkflowViewModel()
    {
        ...
        var extractedFiles = new[]
        {
            ...
            Path.Combine("Components", "GlobalLeakSeatBlacklistEditorViewModel.cs"),
            Path.Combine("Components", "GlobalLeakBlacklistVenueViewModel.cs"),
            Path.Combine("Components", "SeatWorkspaceViewModel.cs"),
